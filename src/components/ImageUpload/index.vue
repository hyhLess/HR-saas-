<template>
    <div>
        ...
        <el-upload :on-preview="preview" :on-remove="handleRemove" :on-change="changeFile" :before-upload="beforeUpload"
            :file-list="fileList" :http-request="upload" list-type="picture-card" action="#" :limit="1"
...
// 需要实例化
const cos = new COS({
    SecretId: 'AKIDd5KK6dvzoQowIRL0QbZJn22nJ2XpthHc',
    SecretKey: 'A6oJgqmUzGJ7pKbfV7WigS1NYXIp9JGz'
